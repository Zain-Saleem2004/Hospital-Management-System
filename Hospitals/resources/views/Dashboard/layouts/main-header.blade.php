                ...
                <div class="dropdown nav-item main-header-notification">
                    ...
                    <div class="dropdown-menu dropdown-notifications">
                        <div class="menu-header-content bg-primary text-right">
							...
							<p data-count="{{App\Models\Notification::where('user_id',auth()->user()->id)->where('reader_status',0)->count()}}" class="dropdown-title-text subtext mb-0 text-white op-6 pb-0 tx-12 notif-count">{{App\Models\Notification::where('user_id',auth()->user()->id)->where('reader_status',0)->count()}}</p>                        </div>
...
<script>
    ...
    var pusher = new Pusher('2809855f32de4adbf201',{
        cluster: 'mt1'
    });
