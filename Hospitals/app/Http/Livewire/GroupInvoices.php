...
class GroupInvoices extends Component
{
    ...
    public function render()
    {
        return view('livewire.group_invoices.group-invoices', [
            'group_invoices'=>Invoice::where('type',2)->get(),
    ...
    {
        $this->price = Groub::where('id', $this->Group_id)->first()->Total_before_discount;
        $this->discount_value = Groub::where('id', $this->Group_id)->first()->discount_value;
        $this->tax_rate = Groub::where('id', $this->Group_id)->first()->tax_rate;
    }
